...
<dc_user_base> control bat execute at o46g4 or c1815u1/u2 and tablespace datafile location
"""
class InitDCProject:
       def __init__(self,project_short,ls_gs,dc_user_base):
              ...
              work_rep_init_bat_script = 'sqlplus dc/dc@o46g4 @01_work_rep_init_script.sql'
              dc_schema_init_bat_script = 'sqlplus dc/dc@{dc_user_base} @03_dc_schema_init_script.sql'
              self.__work_rep_bat = work_rep_init_bat_script
...
# IS AND GS have different odi base
              ...
              impdp rep_{project_short}/rep_{project_short}@o46g4 directory=data_pump_dir dumpfile={exp_db}_{date}.dmp logfile={exp_db}_{date}.log remap_schema={exp_db}:rep_{project_short} full=y ignore=y table_exists_action = replace ;
              """

              #execute at dc_user_base
              self.__create_tablespace_sql_dc_user =  """ 
       ...
       def dc_schema_init_script(self):
              script = self.__create_tablespace_sql_dc_user.format(project_short = self.__project_short,dc_user_base = self.__dc_user_base) + '\n' + self.__create_stage_user_sql.format(project_short = self.__project_short,ls_gs = self.__ls_gs) + '\n' \
...
if __name__=='__main__':
       ...
       ls_gs = ''
       # Test
       init_odi = InitDCProject('POC','LS','o46g4')
